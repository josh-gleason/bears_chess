...
CLI::CLI() :
    ...
    command_handlers{
        { CommandType::EMPTY, std::bind_front(&CLI::handle_empty, this) },
        { CommandType::UNKNOWN, std::bind_front(&CLI::handle_unknown, this) },
        { CommandType::DISPLAY, std::bind_front(&CLI::handle_display, this) },
        { CommandType::PERFT, std::bind_front(&CLI::handle_perft, this) },
        { CommandType::HELP, std::bind_front(&CLI::handle_help, this) },
        { CommandType::UCI, std::bind_front(&CLI::handle_uci, this) },
        { CommandType::DEBUG, std::bind_front(&CLI::handle_debug, this) },
        { CommandType::ISREADY, std::bind_front(&CLI::handle_isready, this) },
        { CommandType::SETOPTION, std::bind_front(&CLI::handle_setoption, this) },
        { CommandType::REGISTER, std::bind_front(&CLI::handle_register, this) },
        { CommandType::UCINEWGAME, std::bind_front(&CLI::handle_ucinewgame, this) },
        { CommandType::POSITION, std::bind_front(&CLI::handle_position, this) },
        { CommandType::GO, std::bind_front(&CLI::handle_go, this) },
        { CommandType::STOP, std::bind_front(&CLI::handle_stop, this) },
        { CommandType::PONDERHIT, std::bind_front(&CLI::handle_ponderhit, this) },
        { CommandType::QUIT, std::bind_front(&CLI::handle_quit, this) },
    },
    help_messages{
